...
function addLongRow() {
  ...
  const row = tbody.insertRow();
  row.insertCell().innerHTML = `<input type="text" class="wide-input" inputmode="decimal">`;
  row.insertCell().innerHTML = `<input type="number" class="mid-input">`;
...
function addPavementRow() {
  ...
  `;
  row.insertCell().innerHTML = `<input type="text" inputmode="decimal" oninput="updatePavementTable()">`;   // 測点
