...
function addPointRow(){
  ...
  const row = tbody.insertRow();
  row.insertCell().innerHTML = `<input type="text" inputmode="text">`;
...
function addLongRow() {
  ...
  const row = tbody.insertRow();
  row.insertCell().innerHTML = `<input type="text" class="mid-input" inputmode="text">`;
  row.insertCell().innerHTML = `<input type="number" class="mid-input">`;
...
function addPavementRow() {
  ...
  `;
  row.insertCell().innerHTML = `<input type="text" inputmode="text" oninput="updatePavementTable()">`;    // 測点
